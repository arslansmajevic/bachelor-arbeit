package project.data_exchange_project.security;
...
public class UserAuthentication {
    ...
    public boolean checkBlockedStatus(String userEmail) throws SecurityException {
        ...
        if (userRepository.findApplicationUserByEmail(userEmail) == null) {
            throw new SecurityException("User with email " + userEmail + " is unknown");
        }
